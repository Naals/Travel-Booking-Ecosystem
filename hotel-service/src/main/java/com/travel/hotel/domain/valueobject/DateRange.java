...
/**
 * Immutable date range — half-open interval [start, end).
 * Reused across hotel, flight, and vehicle services.
 */
public final class DateRange implements ValueObject {
    ...
    public long      nights()   { return ChronoUnit.DAYS.between(start, end); }
    ...
    @Override public boolean equals(Object o) {
        return o instanceof DateRange dr && start.equals(dr.start) && end.equals(dr.end);
    }
