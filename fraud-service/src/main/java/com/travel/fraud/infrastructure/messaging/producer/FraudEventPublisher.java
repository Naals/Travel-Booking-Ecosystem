package com.travel.fraud.infrastructure.messaging.producer;
...
public class FraudEventPublisher {
    ...
    private String resolveTopic(DomainEvent event) {
        return switch (event.getEventType()) {
            case "FraudAlertRaised" -> KafkaTopics.FRAUD_ALERT_RAISED;
            case "RiskFlagCleared"  -> KafkaTopics.FRAUD_RISK_FLAG_CLEARED;
            default -> null;
        };
    }
}
