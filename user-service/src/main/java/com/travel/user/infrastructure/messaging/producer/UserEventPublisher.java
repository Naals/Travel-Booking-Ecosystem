package com.travel.user.infrastructure.messaging.producer;
...
public class UserEventPublisher {
    ...
    private String resolveTopic(DomainEvent event) {
        return switch (event.getEventType()) {
            case "UserProfileCreated" -> KafkaTopics.USER_PROFILE_CREATED;
            case "SavedLocationAdded" -> KafkaTopics.USER_SAVED_LOCATION_ADDED;
            default                   -> null;
        };
    }
}
